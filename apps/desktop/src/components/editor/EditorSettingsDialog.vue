...
const settingsContentClass = computed(() =>
  isSettingsPage.value
    ? "flex h-full min-h-0 flex-col gap-4 overflow-hidden bg-background p-4"
    : "h-[min(80vh,calc(var(--dbx-viewport-height)-2rem))] !max-w-[min(1120px,calc(100vw-2rem))] !w-[min(1120px,calc(100vw-2rem))] grid-rows-[auto_minmax(0,1fr)] gap-3 p-4 sm:!max-w-[min(1120px,calc(100vw-2rem))]",
);
