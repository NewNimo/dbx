...
const showDriverStore = computed(() => showDriverStoreDialog.value);
const showSettingsPage = computed(() => showSettingsDialog.value);
  ...
  <div v-show="!setupRequired && (!needsAuth || authenticated)" class="fixed inset-0 h-screen w-screen overflow-hidden">
    ...
    <TooltipProvider :delay-duration="300">
      <CustomSqlyogShell
        ...
        @explain="(tabId?: string) => tryExplain(undefined, tabId ? { tabId } : undefined)"
